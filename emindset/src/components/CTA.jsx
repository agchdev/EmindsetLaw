    ...
    <section id="budget" className="py-20 bg-[#003673] text-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-3xl mx-auto text-center animate-fade-in">
          <span className="inline-block text-sm font-semibold text-primary-light mb-4">¿NECESITAS ASESORAMIENTO?</span>
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Solicita un presupuesto sin compromiso</h2>
          <p className="text-xl mb-8 opacity-90">Nuestro equipo se pondrá en contacto contigo en menos de 24 horas para analizar tu caso.</p>
          <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
            ...
            <a href="tel:+34912345678" className="btn-hover inline-flex items-center justify-center bg-transparent text-white font-bold px-8 py-3.5 rounded-full hover:bg-white/10 transition-all duration-300">
              <FontAwesomeIcon icon={faPhoneAlt} className="mr-3" /> LLÁMANOS
            </a>
          </div>
        </div>
      </div>
